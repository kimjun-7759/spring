...
<title>Photowall Photo Gallery Category Bootstrap Responsive
	Template | Plans :: W3layouts</title>
<!-- Meta tag Keywords -->
...
<body>
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					Board List Page
					<button id='regBtn' type="button" class="btn btn-xs pull-right"><a href="/front/f_register">Register
						New Board</a></button>
				</div>
				...
				<div class="panel-body">
					...
					<div class='row'>
						<div class="col-lg-12">
							...
							<form id='searchForm' action="/front/free_board" method='get'>
								<select name='type'>
									<option value=""
					...
					<!-- 페이징 Form 시작 -->
					<form id='actionForm' action="/front/free_board" method='get'>
   ...
   $(document).ready(function() {
      ...
      $(".move").on("click",function(e) {
         ...
         actionForm.attr("action", "/front/f_get");
         actionForm.submit();
      });
